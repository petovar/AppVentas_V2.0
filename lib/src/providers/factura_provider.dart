...
class FacturaProvider extends ChangeNotifier {
  ...
  Future<Map<String, dynamic>> getSalesSummary({
    ...
    final paymentsByMethod = await _database.rawQuery(
      'SELECT T2.metodo_pago, SUM(T2.monto_pago) as total FROM master_ventas T1 JOIN pagos_ventas T2 ON T1.id_venta = T2.id_venta $whereClause GROUP BY T2.metodo_pago',
      whereArgs,
    );
